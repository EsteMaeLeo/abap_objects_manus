class ZCL_ZAUTOUSER_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZAUTOUSER_MPC=============CP' ##NO_TEXT.
...
CLASS ZCL_ZAUTOUSER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZAUTOUSER_SRV' ).
...
lo_action = model->create_action( 'LockUser' ).  "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'UserId'    iv_abap_fieldname = 'USER_ID' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZAUTOUSER_MPC=>TS_LOCKUSER' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAUTOUSER_MPC=>TS_RETURN' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UserType' iv_abap_fieldname = 'USER_TYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UserClass' iv_abap_fieldname = 'USER_CLASS' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 12 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TitleP' iv_abap_fieldname = 'TITLE_P' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TitleAca1' iv_abap_fieldname = 'TITLE_ACA1' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LanguP' iv_abap_fieldname = 'LANGU_P' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ChangePassDate' iv_abap_fieldname = 'CHANGE_PASS_DATE' ). "#EC NOTEXT
lo_property->set_type_edm_datetime( ).
lo_property->set_precison( iv_precision = 7 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZST_MANAGE_USR'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220927233009'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'return'.                            "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'LockUser'.                                     "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'LockUser'.                                      "#EC NOTEXT
